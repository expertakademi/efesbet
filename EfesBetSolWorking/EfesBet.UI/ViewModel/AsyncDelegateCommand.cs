...
{
    ///// <summary>
    ///// taken from http://www.amazedsaint.com/2010/10/asynchronous-delegate-command-for-your.html
    ...
    public class AsyncDelegateCommand : ICommand
    {
        ...
        public AsyncDelegateCommand(Action action,
            Func<bool> canExecute = null, Action<object> completed = null,
            Action<Exception> error = null)
        {
            _worker.DoWork += (s, e) =>
            {
                CommandManager.InvalidateRequerySuggested(); action();
            };
        ...
        //- See more at: http://www.amazedsaint.com/2010/10/asynchronous-delegate-command-for-your.html#sthash.DDQ43atA.dpuf
